      ...
      {toast && (
        <div
          style={{
            ...
            background: toast.type === 'error' ? 'var(--tier-red-bg)' : 'var(--bg-card)',
            border: `0.5px solid ${toast.type === 'error' ? 'var(--tier-red-border)' : 'var(--border-medium)'}`,
            color: toast.type === 'error' ? 'var(--tier-red)' : 'var(--text-primary)',
            borderRadius: 20,
            padding: '10px 18px',
            fontSize: 14,
            ...sans,
